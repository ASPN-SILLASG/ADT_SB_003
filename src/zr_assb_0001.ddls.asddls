...
@EndUserText.label: '[SB] 플랜트레벨 일 수불'
@Metadata.ignorePropagatedAnnotations: true
define root view entity ZR_ASSB_0001 as select from zassbt0001 as _sb
                                                       ...
                                                       and _Matkl.Language   = '3'
{
  key _sb.uuid                 as UUID,
      ...
      $session.system_language as Langu, //언어키를 필터로 적용된 value help가 적용되지 않음. 확인 필요.

      @ObjectModel.text.element: ['Matklt']
      @Consumption.valueHelpDefinition: [{entity: {name: 'I_ProductGroupText_2', element: 'ProductGroup' },
                                        additionalBinding: [{localElement: 'Langu', element: 'Language', usage: #FILTER}]}]
